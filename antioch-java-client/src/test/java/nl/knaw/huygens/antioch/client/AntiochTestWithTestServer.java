...
public abstract class AntiochTestWithTestServer extends AntiochTest {
  static final String AUTHKEY = "AUTHKEY";

  protected static final URI testURI = URI.create("http://localhost:2016/");
  private static HttpServer testServer;
  private static final AntiochConfiguration testConfig = new AntiochConfiguration() {
    @Override
  ...
  public static void startTestServer() {
    ...
    final AntiochService service = locator.getService(AntiochService.class);
    final ResourceConfig resourceConfig = new AntiochApplication();
  ...
  private static ServiceLocator createServiceLocator() {
    ...
    final AbstractModule configModule = new AbstractModule() {
      ...
      protected void configure() {
        bind(AntiochConfiguration.class).toInstance(testConfig);
      }
    };
