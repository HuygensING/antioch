...
@Deprecated
public class DeprecatedTextView {
  ...
  public DeprecatedTextView(String name) {
    this.name = name;
  }
  ...
  public DeprecatedTextView setDescription(String description) {
  ...
  public DeprecatedTextView setIncludedElementDefinitions(final List<ElementDefinition> baseElements) {
  ...
  public DeprecatedTextView setIgnoredElements(List<String> ignoredElements) {
  ...
  public DeprecatedTextView setExcludedElements(List<String> excludedElementTags) {
  ...
  public DeprecatedTextView setTextViewDefiningResourceId(UUID textViewDefiningResourceId) {
