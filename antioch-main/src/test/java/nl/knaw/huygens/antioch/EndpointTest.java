...
public abstract class EndpointTest extends JerseyTest {
  ...
  private static AntiochConfiguration testConfiguration() {
  ...
  public static class TestModule extends AbstractModule {
    private final AntiochService serviceInstance;

    public TestModule(AntiochService serviceInstance) {
    ...
    protected void configure() {
      ...
      bind(AntiochService.class).toInstance(serviceInstance);
