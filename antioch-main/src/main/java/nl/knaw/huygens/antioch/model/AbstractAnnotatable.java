...
public abstract class AbstractAnnotatable extends AbstractAccountable {
  ...
  private final Set<AntiochAnnotation> annotations = new HashSet<>();

  protected AbstractAnnotatable(UUID id, TentativeAntiochProvenance provenance) {
    super(id, provenance);
  }

  public Set<AntiochAnnotation> getAnnotations() {
    return Collections.unmodifiableSet(annotations);
  }

  public void addAnnotation(AntiochAnnotation annotation) {
