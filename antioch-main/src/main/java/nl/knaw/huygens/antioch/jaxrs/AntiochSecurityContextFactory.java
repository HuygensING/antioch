...
import static nl.knaw.huygens.antioch.jaxrs.AntiochRoles.ANONYMOUS;
...
public class AntiochSecurityContextFactory {
  private final Map<String, String> keyMap; // authKey -> username

  @Inject
  public AntiochSecurityContextFactory(AntiochConfiguration config) {
