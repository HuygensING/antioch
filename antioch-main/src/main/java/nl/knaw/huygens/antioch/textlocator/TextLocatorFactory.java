...
public class TextLocatorFactory {
  ...
  private static final Map<String, Function<String, ? extends AntiochTextLocator>> prefix2locator = new HashMap<>();
  ...
  private AntiochService service;

  @Inject
  public TextLocatorFactory(AntiochService service) {
    this.service = service;
  }

  public AntiochTextLocator fromString(String locatorString) throws TextLocatorParseException {
  ...
  public void validate(AntiochTextLocator locator, AntiochResource resource) {
