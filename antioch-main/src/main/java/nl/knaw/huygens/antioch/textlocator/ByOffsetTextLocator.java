...
public class ByOffsetTextLocator implements AntiochTextLocator {
  ...
  // public AntiochTextLocator withStart(Long start) {
  // setStart(start);
  // return this;
  // }
  ...
  // public AntiochTextLocator withLength(Long length) {
  // setLength(length);
  // return this;
  // }
