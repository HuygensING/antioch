...
import static nl.knaw.huygens.antioch.api.EndpointPaths.SEARCHES;
...
public class SearchEndpoint extends JSONEndpoint {
  ...
  @Inject
  public SearchEndpoint(final AntiochService service, //
  ...
  public Response createSearchResult(@NotNull @Valid AntiochQuery query) {
